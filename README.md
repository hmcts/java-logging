...
Gradle:
```groovy
compile group: 'uk.gov.hmcts.reform', name: 'java-logging-spring', version: '3.0.3'
```
...
Gradle:
```groovy
compile group: 'uk.gov.hmcts.reform', name: 'java-logging-httpcomponents', version: '3.0.3'
```
