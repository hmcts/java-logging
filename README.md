...
Gradle:
```groovy
compile group: 'uk.gov.hmcts.reform', name: 'java-logging-spring', version: '1.6.2'
```
...
Gradle:
```groovy
compile group: 'uk.gov.hmcts.reform', name: 'java-logging-httpcomponents', version: '1.6.2'
```
