...
class TestAppender extends AppenderBase<ILoggingEvent> {
    ...
    public void assertEvent(int index, Level expectedLevel, String expectedMessage, Object expectedMarker) {
        ...
        assertThat(event(index).getMarker()).isEqualTo(expectedMarker);
    }
